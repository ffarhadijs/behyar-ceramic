        ...
        {({ errors, touched }) => (
          <Form>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center my-6">
              <button type="submit" className="text-sm font-semibold mb-6 sm:mb-0 rounded-[50px] w-[100px] text-white appearance-none outline-none bg-[#0095da] border-0 p-[12px] flex flex-row items-center justify-between cursor-pointer transition-colors duration-300 hover:bg-white  hover:text-[#0095da] hover:shadow-[#0095da4d] hover:shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row  font-vazir items-center">
                <span className="font-vazir my-4 text-sm">حساب کاربری ندارید؟</span>
                <Link to="/sign-up">
                  <button
                    className={
                      "rounded-[50px] text-sm font-semibold text-white appearance-none outline-none bg-[#3b414d] border-0 w-[100px] p-[12px] cursor-pointer transition-colors duration-300 mr-[10px] font-vazir hover:text-[#3b414d] hover:bg-white hover:shadow-[#3b414d4d] hover:shadow-xl "
                    }
                  >
                    {" "}
                    ثبت نام{" "}
